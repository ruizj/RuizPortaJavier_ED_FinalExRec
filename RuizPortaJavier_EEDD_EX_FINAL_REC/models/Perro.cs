...
namespace RuizPortaJavier_EEDD_EX_FINAL_REC.models
{
    class Perro : Animal
    {
        ...
        //Constructor
        public Perro(string nombre, string raza, string fechaNacimiento, double peso, string microship, string comentarios) : base(nombre, fechaNacimiento, peso, comentarios)
        {
            Raza = raza;
            Microship = microship;
        }
